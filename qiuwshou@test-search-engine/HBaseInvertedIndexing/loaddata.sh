...
#mkdir -p /root/MoocHomeworks/HBaseWordCount/data/clueweb09/files
...
#./bin/hadoop jar lib/cglHBaseMooc.jar iu.pti.hbaseapp.HBaseTableReader clueweb09DataTable details string string string string 1 > dataTable.txt
