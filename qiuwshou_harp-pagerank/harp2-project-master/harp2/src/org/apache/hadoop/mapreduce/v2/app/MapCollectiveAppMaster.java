...
public class MapCollectiveAppMaster extends
  ...
  private final class ContainerAllocatorRouter
    ...
    ContainerAllocatorRouter(
      ...
      AppContext context) {
      super(ContainerAllocatorRouter.class
        .getName());
    ...
    @Override
    public void runOnNextHeartbeat(
      Runnable callback) {
      ((RMCommunicator) this.containerAllocator)
  ...
  private final class ContainerLauncherRouter
    ...
    ContainerLauncherRouter(AppContext context) {
      super(ContainerLauncherRouter.class
        .getName());
      this.context = context;
    }
  ...
  private static void validateInputParam(
  ...
  public static void main(String[] args) {
    ...
    LOG
      .info("MapCollectiveAppMaster (MRAppMaster) starts.");
    try {
      Thread
        .setDefaultUncaughtExceptionHandler(new YarnUncaughtExceptionHandler());
      String containerIdStr =
        System.getenv(Environment.CONTAINER_ID
          .name());
      ...
      String nodeHttpPortString =
        System.getenv(Environment.NM_HTTP_PORT
          .name());
      String appSubmitTimeStr =
        System
          .getenv(ApplicationConstants.APP_SUBMIT_TIME_ENV);
      ...
      String jobUserName =
        System
          .getenv(ApplicationConstants.Environment.USER
            .name());
      conf
        .set(MRJobConfig.USER_NAME, jobUserName);
      ...
      // the objects myself.
      conf
        .setBoolean("fs.automatic.close", false);
